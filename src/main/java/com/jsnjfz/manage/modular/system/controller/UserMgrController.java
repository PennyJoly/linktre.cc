...
import com.jsnjfz.manage.modular.system.utils.ImgUtil;
...
//    }
    ...
    @RequestMapping(method = RequestMethod.POST, path = "/upload")
    @ResponseBody
    public String compressionUpload(@RequestPart("file") MultipartFile file) throws IOException {
        MultipartFile file1 = ImgUtil.commpressPicCycle(Long.parseLong("100"), Double.parseDouble("0.5f"), file);
        return qiniuService.uploadFile(file1,10);
    }
